      ...
      <div class="card-body">
        ...
        <table class="table table-bordered table-striped table-hover">
          <tr>
            ...
            $No = 1;
            $tampil = mysqli_query($konek, "SELECT * FROM nilai ORDER BY id_nilai DESC");
              ...
              <div class="modal-content">
                ...
                <form method="POST" action="aksi_crud3.php">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="mb-3">
                       <label class="form-label">Nilai Pembimbing Lapangan</label>
                      <input type="file" class="form-control" name="tnilai_pembimbing_lapangan" value="<?= $data["nilai_pembimbing_lapangan"] ?>" placeholder="Masukkan File!">
                    </div>
                    ...
                    <div class="mb-3">
                      <label class="form-label">Nilai Penguji</label>
                      <input type="file" class="form-control" name="tnilai_penguji" value="<?= $data["nilai_penguji"] ?>" placeholder="Masukkan File!">
                    </div>
                ...
                <form method="POST" action="aksi_crud3.php">
                  ...
                  <div class="modal-body">
                    ...
                    <h5 class="text-center">Apakah anda yakin ingin menghapus data ini? <br>
                      <span class="text-danger"><?= $data['nilai_pembimbing_lapangan'] ?></span>
                    </h5>
        ...
        <div class="modal fade" id="ModalTambah" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Unggah Nilai</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <form method="POST" action="aksi_crud3.php">
                <div class="modal-body">
                  ...
                  <div class="mb-3">
                    <label class="form-label">Nilai Pembimbing Lapangan</label>
                    <input type="file" class="form-control" name="tnilai_pembimbing_lapangan">
                  </div>

                  <div class="mb-3">
                    <label class="form-label">Nilai Pembimbing KP</label>
                    <input type="file" class="form-control" name="tnilai_pembimbing_kp"> 
                  </div>

                  <div class="mb-3">
                    <label class="form-label">Nilai Penguji</label>
                    <input type="file" class="form-control" name="tnilai_penguji">
                  </div>


                  <div class="mb-3">
                    <label class="form-label">Bukti Nilai Pembimbing lapangan</label>
                    <input type="file" class="form-control" name="tbukti_nilai_pembimbing_lapangan">
                  </div>
